...
import Myself from '../../assets/images/IMG_2302.PNG';
      ...
      <div className="hero">
        <div className="hero__container">
          <div className="hero__intro-box">
            <p className="hero__intro-title" style={{color:'rgba(254,194,0,1)'}}>
...
<p>I'm a dedicated <span>front-end developer</span> with 2 years of experience crafting responsive, high-performance web and mobile applications using Next.js, React.js, and TypeScript, delivering clean, efficient, and user-friendly code.</p>
