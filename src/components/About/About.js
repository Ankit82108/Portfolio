          ...
          <div className="about__details-container">
            ...
            >
              <Link to="/about/intro">
                ...
                <p>
                  I am <span>Ankit Kumar.</span> <br /> Highly passoinate
            ...
            >
              <Link to="/about/internships">
                ...
                <ul>
                  <li>
                    <span>Datametricks Pvt Ltd</span> - Front-end Developer{" "}
                  </li>
                  {/* <li>
            ...
            >
              <Link to="/about/graduation">
                ...
                <p>
                  <span>Technocrats Institute of Technology</span>
                  <br />
                     Completed MCA, gaining strong expertise in software development, data structures, web technologies, and modern programming practices. Focused on building scalable applications and problem-solving through real-world projects and research work.
