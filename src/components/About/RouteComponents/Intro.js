        ...
        <div className="about-intro__container">
          ...
          <div className="about-intro__description">
            ...
            <p data-aos="fade-right" data-aos-delay="800">
              Skilled in modern web technologies including TypeScript, Tailwind
              CSS, and Bootstrap, with a strong focus on performance
              optimization and clean, maintainable code.
            </p>
            <p data-aos="fade-right" data-aos-delay="1000">
              I thrive in collaborative environments, enjoy solving problems,
              and continuously explore new tools and frameworks to stay up to
